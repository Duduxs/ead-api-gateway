...
$ git clone https://github.com/Duduxs/ead-api-gateway
...
## :memo: License
This project is under the MIT license. See the [LICENSE](https://github.com/Duduxs/ead-api-gateway/blob/main/LICENSE) for more information.
